...
function chaine(tableau,lettre){
var newtable=[]
each(tableau,func(el,i)){
if(i.indexof(lettre)!==-1){
newtable.push(i)
}
}
...
function tableau(objet,etudiant){
NOMS=[]
each(tableau,func(el.i)){
NOMS.push(el.NOMS)
}
...
var somme=0
each(tableau,function(i,sous tableau)){

}
each(sous tableau,function(jnombres)){
    somme=somme+nombres
}
